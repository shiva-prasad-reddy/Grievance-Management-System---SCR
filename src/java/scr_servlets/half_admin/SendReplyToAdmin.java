...
public class SendReplyToAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String rtid = null, subject = null, fileno = null, to = null, type = null;
        ...
        try {
            ...
            if (isMultipart) {
                ...
                if (subject != null && rtid != null && fileno != null && to != null && type != null) {
                    ...
                    if (include != null) {
                        String[] uf = include.split("~");
                        fnames.addAll(Arrays.asList(uf));
                    }

                    admin.sendReplyToAdmin(tid, subject, fileno, to, fnames, rtid, type);
